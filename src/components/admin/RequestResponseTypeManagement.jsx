    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Talep/İstek Türü Yönetimi</h1>
            <p className="mt-2 text-gray-600">Sistemdeki talep/istek türlerini yönetin</p>
          </div>
          <button
        ...
        {types.length === 0 ? (
          <div className="col-span-full">
            <div className="text-center py-12">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">Henüz tür yok</h3>
              <p className="mt-2 text-gray-500">İlk türünüzü ekleyerek başlayın</p>
            </div>
          </div>
        ) : (
          types.map((type) => (
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-500 mt-1">Talep/İstek Türü</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-semibold text-gray-900">
                  {editingType ? 'Tür Düzenle' : 'Yeni Tür Ekle'}
                </h3>
                <button
                  onClick={closeModal}
...
export default RequestResponseTypeManagement;
