  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingDepartment) {
        // Update department - ID'yi de gönder
        const updateData = {
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="mt-2 text-gray-600">Sistemdeki departmanları yönetin</p>
          </div>
          <button
        ...
        {departments.length === 0 ? (
          <div className="col-span-full">
            <div className="text-center py-12">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">Henüz departman yok</h3>
              <p className="mt-2 text-gray-500">İlk departmanınızı ekleyerek başlayın</p>
            </div>
          </div>
        ) : (
          departments.map((department) => (
            <div key={department.id} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden group">
              <div className="p-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-500 mt-1">Departman</p>
                      </div>
                    </div>
                  </div>
                </div>
